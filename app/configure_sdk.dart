...
void main() async {
  ...
  if (result.exitCode != 0) {
    print(
        'Error: Flutter SDK not found. Make sure Flutter is installed and in your PATH.');
    return;
  }
    ...
    <panes>
      <pane id="ProjectPane">
        <subPane>
          <PATH>
            <PATH_ELEMENT>
              <option name="myItemId" value="QuranEcho" />
...
''';
  ...
  print(
      'SDK configuration complete. Try reopening the project in Android Studio.');
}
