...
import 'pages/makharij_debug_page.dart'; // Add debug page import
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/read_select': (context) => const ReadSurahSelectPage(),
        '/read_quran': (context) => ReadQuranPage(
              surahInfo: ModalRoute.of(context)!.settings.arguments
                  as Map<String, dynamic>,
            ),
        '/dashboard': (context) => const DashboardPage(),
        '/makharij_debug': (context) =>
            const MakharijDebugPage(), // Add this route
      },
    );
  }
}
