        ...
        child: Column(
          ...
          children: [
            Icon(
              ...
              size: 70,
              color: const Color(0xFF00A896), // Updated to match Hifz page color
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white.withOpacity(0.9), // White background for better readability
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  isExpanded: true,
                  hint: const Text('Choose a reciter', style: TextStyle(color: Colors.black87)),
                  value: _selectedReciter,
                  dropdownColor: Colors.white, // Ensure dropdown menu has white background
                  style: const TextStyle(color: Colors.black87, fontSize: 16), // Text color for selected item
            ...
            Container(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  isExpanded: true,
                  hint: const Text('Choose a surah', style: TextStyle(color: Colors.black87)),
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                disabledBackgroundColor: Colors.grey.shade700, // Darker disabled color for dark theme
              ),
