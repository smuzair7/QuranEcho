...
class _HifzPageState extends State<HifzPage> {
  ...
  Future<void> _processAudioWithAPI() async {
    ...
    try {
      ...
      debugPrint("Sending ${audioBytes.length} bytes to Tarteel AI Whisper Quran model");
      ...
      if (response.statusCode == 200) {
        ...
        if (response.statusCode == 400) {
          ...
          debugPrint("503 Service Unavailable - The model might be loading or unavailable");
        }
      }
    } catch (e) {
      setState(() {
